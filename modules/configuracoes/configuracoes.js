      ...
      <div style="display: flex; flex-direction: column; gap: 20px; max-width: 900px;">
        ...
        <div class="card" style="padding: 14px 20px;">
          ...
          <div style="font-size: 11px; color: #94a3b8; margin-top: 2px;">
            Dados fiscais da empresa, parâmetros de hardware (balança/impressora), lojas e assinatura SaaS.
          </div>
        </div>
        ...
        <div class="card">
          ...
          <div style="display: grid; grid-template-columns: 1fr 1fr; gap: 12px;">
            ...
            <div>
              <label style="font-size: 11px; font-weight: 700; color: #cbd5e1; display: block; margin-bottom: 4px;">NUIT Moçambique:</label>
            ...
            ${stores.map(s => `
              <div style="display: flex; justify-content: space-between; align-items: center; padding: 10px 14px; background: #0f172a; border-radius: 8px; border: 1px solid #1f2937;">
                <div>
                  ...
                  <div style="font-size: 10px; color: #94a3b8;">${s.address || 'Moçambique'} • Status SaaS: <span style="color: #34d399;">ATIVO</span></div>
                </div>
                ${s.id === currentStoreId ? `
